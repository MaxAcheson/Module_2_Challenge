...
def save_qualifying_loans(qualifying_loans):
    ...
    if len(qualifying_loans) == 0: # This conditional checks if the length of the list of loans is equal to zero. If it is zero, then the list is empty and it passes to the system exit message.
